...
### Receipt-bound observed release/current-work history (2026-07-30)

The reviewed Plan 01-45 receipt is bound to reviewed commit `1a9449be4d74aa1ceed235d949802266846cf63b` and its four immutable report digests (receipt SHA-256 `9b4c25c55abf6eea280bec2dbb8d4674abda75c05447223907fa62fe6e753329`). It contributes only observed repository history: `napplet/web` manifest source at `4916777862ababd09fa13cf155f4b4079c8e8cb1:packages/cli/src/manifest.ts`, convention source at `dd7b3a728eb9c838b7218fcec7bb7bb00e7cc88b:packages/nap/src/convention-uri.ts`, observed release metadata at `60889f1c2476e063500c7ab6624af6abe0dbcbe5:packages/nap/package.json`, and `kehto/web` runtime/release-metadata observations at `b85db51db838866de753b275b9d34ec908785bd2:RUNTIME-SPEC.md` and `4eafa058d18cf245b23d49b23bc29dda0b7d7651:packages/runtime/package.json`. The audit-gateway candidate has an invalid approved commit locator and remains a retained failed observation; the `napplet/naps` rolling window is a retained zero-result observation. None is an independently fetched published artifact, package admission, root-export proof, runtime/example/fixture/conformance result, or approval. `SPK-G` and `CMP-BASELINE-001` remain blocked pending all qualified dimensions and separate approval.
