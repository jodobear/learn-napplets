...
**Unresolved questions:** OQ-EGRESS-NIP-001; OQ-FIREFOX-PLAYWRIGHT-LAUNCH-001 remain blocked pending immutable upstream evidence and, for Firefox, attached-context measurements under the approved toolchain. The only source bindings are project policy/archive inputs; Chrome measures one disposable local fixture, Firefox has no attached-context result, and neither result establishes upstream protocol behavior or a production CSP.
